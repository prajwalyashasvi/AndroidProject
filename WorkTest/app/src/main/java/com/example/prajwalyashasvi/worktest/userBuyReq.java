...
public class userBuyReq extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_buy_req);
        status = (ListView)findViewById(R.id.listViewBuy);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_user_buy_req, menu);
        return true;
    }
    ...
    private class searchBookAllDb extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... urls) {
            try {
                ...
                String link = "http://weblab.cs.uml.edu/~ayallapr/prajwalAndroid/buybookads.php?"+qstr;
        ...
        protected void onPostExecute(String result) {
            ...
            simpleAdpt=new SimpleAdapter(this.context, dataList, android.R.layout.simple_list_item_1, new String[]{"data"}, new int[]{android.R.id.text1});
            status.setAdapter(simpleAdpt);
        }
